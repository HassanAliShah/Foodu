...
class HTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w400, color: HColors.textPrimary),

    titleLarge: TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.w600, color:HColors.textblack),
    titleMedium: TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: HColors.textPrimary),
    titleSmall: TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w400, color: HColors.textGrey),
    ...
    bodySmall: TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: HColors.textGrey),

    labelLarge: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: HColors.textPrimary),
